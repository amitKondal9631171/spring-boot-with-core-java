 ...
 * Stream is a new abstract layer introduced in Java 8. Using stream, you can process data in a declarative way similar to SQL statements.
 ...
 SELECT max(salary), employee_id, employee_name FROM CustomSort
...
public class JavaStreams {
    ...
    public static void main(String args[]) {
        ...
        String[] array8 = {"abc", "", "bc", "efg", "abcd","", "jkl"};

        long countArray = Arrays.stream(array8).filter(string -> string.isEmpty()).count();
        ...
        //Eliminate empty string and join using comma. //java 7
        ...
        //get list of square of distinct numbers //java 7
        ...
        //print ten random numbers //java 7
