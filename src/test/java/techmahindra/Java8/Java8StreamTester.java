 ...
 * following operations can be performed on streams :
 * filter: to filter the objects from the sequence of objects
 * map: map the objects to the collections like list and map
 * sort: the elements in the stream
 * foreach: iterate the elements in the stream
...
/**
 *
 * Reduce is used to return single value from the stream like sum of the stream, concatinate the values of the stream and return single value
 */
